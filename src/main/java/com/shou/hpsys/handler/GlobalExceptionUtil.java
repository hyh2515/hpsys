package com.shou.hpsys.handler;
...
import com.shou.hpsys.web.login.util.LoginExceptionUtil;
...
public class GlobalExceptionUtil {
    ...
    public static CommonResult<String> getCommonResult(Exception e) {
        ...
        if (e instanceof HttpRequestMethodNotSupportedException) {
            ...
            return LoginExceptionUtil.getCommonResult(e);
    ...
    /**
     * @description: 获取请求参数不正确的提示信息，多个信息，拼接成用逗号分隔的形式
     * @param: constraintViolationSet
     * @return: java.lang.String
     * @author Yaohui Hu
     * @date: 2024/3/21 21:26
     */
